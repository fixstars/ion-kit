...
int main() {
    try {
        ...
        // Index access style
        {
            ...
            Node n;
            n = b.add("test_array_copy")(input).set_param(Param("len", len));
            n = b.add("test_array_input")(n["array_output"]).set_param(Param("len", len));
        ...
        // Direct style
        {
            ...
            b.set_target(Halide::get_host_target());
            Node n;
            n = b.add("test_array_copy")(ins).set_param(Param("len", len));
            n = b.add("test_array_input")(n["array_output"]).set_param(Param("len", len));
