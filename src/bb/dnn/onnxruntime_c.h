// Some code fragments in this file are copied from ONNXRuntime.
// Copyright (c) Microsoft Corporation. All rights reserved.
// Licensed under the MIT License.
// https://github.com/microsoft/onnxruntime/blob/master/LICENSE

#ifndef ION_BB_DEMO_RT_ONNXRUNTIME_H
#define ION_BB_DEMO_RT_ONNXRUNTIME_H
...
#define ORT_API_STATUS(NAME, ...)                                                         \
    ORT_EXPORT _Check_return_ _Ret_maybenull_ OrtStatusPtr ORT_API_CALL NAME(__VA_ARGS__) \
...
public:
    ...
    void enable_tensorrt_provider(OrtSessionOptions *session_options, int device_id) {
        OrtSessionOptionsAppendExecutionProvider_Tensorrt_t activate_trt_provider = dm_.get_symbol<OrtSessionOptionsAppendExecutionProvider_Tensorrt_t>("OrtSessionOptionsAppendExecutionProvider_Tensorrt");
        check_status(activate_trt_provider(session_options, device_id));
    }

    void check_status(OrtStatus *status) const {
        if (status != NULL) {
