...
extern "C" ION_EXPORT int ion_bb_image_io_binary_gendc_saver(halide_buffer_t *id_buf, halide_buffer_t *gendc, halide_buffer_t *deviceinfo,
...
extern "C" ION_EXPORT int ion_bb_image_io_binary_image_saver(
