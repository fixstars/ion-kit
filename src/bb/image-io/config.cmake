...
if(JPEG_FOUND AND PNG_FOUND AND ZLIB_FOUND)
    ...
    if(VCPKG_INSTALLED_DIR)
        ...
        find_file(JPEG_DSO NAMES jpeg62.dll libjpeg62.so PATHS ${VCPKG_CANDIDATE_DIR})
        find_file(PNG_DSO NAMES libpng16.dll libpng16.so PATHS ${VCPKG_CANDIDATE_DIR})
        find_file(ZLIB_DSO NAMES zlib1.dll zlib1.so PATHS ${VCPKG_CANDIDATE_DIR})
