...
int main() {
    try {
        ...
        ln = b.add("base_schedule")(ln["output"]).set_params(Param{"output_name", "scaled_left"}, Param{"compute_level", "compute_root"}, Param("input.type", "float32"), Param("input.dim", 3));
        ...
        rn = b.add("base_schedule")(rn["output"]).set_params(Param{"output_name", "scaled_right"}, Param{"compute_level", "compute_root"}, Param("input.type", "float32"), Param("input.dim", 3));
