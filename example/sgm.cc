...
int main() {
    try {
        ...
        //Node ln = b.add("genesis_cloud_image_loader").set_param(Param{"url", "http://vision.middlebury.edu/stereo/data/scenes2006/FullSize/Aloe/Illum3/Exp2/view0.png"});
        ...
        // Node rn = b.add("genesis_cloud_image_loader").set_param(Param{"url", "http://vision.middlebury.edu/stereo/data/scenes2006/FullSize/Aloe/Illum3/Exp2/view1.png"});
