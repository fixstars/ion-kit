...
int main(int argc, char *argv[]) {
    try {
        ...
        Node n;
        n = b.add("image_io_color_data_loader").set_param(Param{"url", "https://ion-kit.s3.us-west-2.amazonaws.com/images/pedestrian.jpg"}, Param{"width", std::to_string(width)}, Param{"height", std::to_string(height)});
