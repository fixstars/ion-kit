...
void display_and_save(int32_t width, int32_t height, std::string directory_path, rawHeader header_info, bool last_run) {
    ...
    n = b.add("image_io_binarysaver")(rp, lp, fcp, dispose_writer, wp, hp).set_params(Param{"output_directory", directory_path}, Param{"fps", "60.0"});
    ...
    n = b.add("image_processing_bayer_demosaic_simple")(n["output"]).set_params(Param{"bayer_pattern", "GBRG"}, Param{"width", std::to_string(width)}, Param{"height", std::to_string(height)});
    n = b.add("image_processing_resize_bilinear_3d")(n["output"]).set_params(Param{"width", std::to_string(width)}, Param{"height", std::to_string(height)}, Param{"scale", std::to_string(2.0f)});
    n = b.add("base_denormalize_3d_uint8")(n["output"]);
    n = b.add("image_processing_crop_image_3d_uint8")(n["output"]).set_params(Param{"input_width", std::to_string(width)}, Param{"input_height", std::to_string(height)}, Param{"output_width", std::to_string(width)}, Param{"output_height", std::to_string(height)}); /*optional*/
    lp = n["output"];
