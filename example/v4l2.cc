...
int main(int argc, char *argv[]) {
    ...
    auto n0 = b.add("image_io_camera").set_params(Param{"fps", "25"}, Param{"width", std::to_string(width)}, Param{"height", std::to_string(height)}, Param{"index", "0"}, Param{"url", "http://optipng.sourceforge.net/pngtech/img/lena.png"});
    auto n1 = b.add("image_io_camera").set_params(Param{"fps", "25"}, Param{"width", std::to_string(width)}, Param{"height", std::to_string(height)}, Param{"index", "1"}, Param{"url", "http://optipng.sourceforge.net/pngtech/img/lena.png"});
    auto n2 = b.add("image_io_camera_simulation").set_params(Param{"fps", "25"}, Param{"width", std::to_string(width)}, Param{"height", std::to_string(height)}, Param{"url", "http://optipng.sourceforge.net/pngtech/img/lena.png"}, Param{"bit_width", "10"}, Param{"bit_shift", "6"}, Param{"gain_r", "0.4"}, Param{"gain_g", "0.5"}, Param{"gain_b", "0.3125"}, Param{"offset", "0.0625"});
    auto n3 = b.add("image_io_camera_simulation").set_params(Param{"fps", "25"}, Param{"width", std::to_string(width)}, Param{"height", std::to_string(height)}, Param{"url", "http://optipng.sourceforge.net/pngtech/img/lena.png"}, Param{"bit_width", "10"}, Param{"bit_shift", "6"}, Param{"gain_r", "0.4"}, Param{"gain_g", "0.5"}, Param{"gain_b", "0.3125"}, Param{"offset", "0.0625"});
    auto n4 = b.add("image_io_imx219").set_params(Param{"fps", "25"}, Param{"width", std::to_string(width)}, Param{"height", std::to_string(height)}, Param{"index", "4"}, Param{"url", "http://optipng.sourceforge.net/pngtech/img/lena.png"});
    auto n5 = b.add("image_io_imx219").set_params(Param{"fps", "25"}, Param{"width", std::to_string(width)}, Param{"height", std::to_string(height)}, Param{"index", "5"}, Param{"url", "http://optipng.sourceforge.net/pngtech/img/lena.png"});
