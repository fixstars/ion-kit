...
//     using GeneratorParam = Halide::NamesInterface::GeneratorParam<T_>;
//
//     template<typename T_>
//     using GeneratorInput = Halide::GeneratorInput<T_>;
//
//     template<typename T_>
//     using GeneratorOutput = Halide::GeneratorOutput<T_>;
//
//     template<typename T_>
//     using Param = Halide::GeneratorParam<T_>;
//
//     template<typename T_>
//     using Input = Halide::GeneratorInput<T_>;
//
//     template<typename T_>
//     using Output = Halide::GeneratorOutput<T_>;
};
// using BuildingBlock = Halide::Generator<T>;
