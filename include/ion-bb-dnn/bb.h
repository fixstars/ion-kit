...
public:
    ...
    GeneratorParam<std::string> model_root_url_{"model_base_url", "https://ion-kit.s3.us-west-2.amazonaws.com/models/"};
...
public:
    ...
    GeneratorParam<std::string> model_root_url_{"model_base_url", "https://ion-kit.s3.us-west-2.amazonaws.com/models/tlt_object_detection_ssd_resnet18/"};
    GeneratorParam<std::string> cache_root_{"cache_root", "/tmp/"};
...
public:
    ...
    GeneratorParam<std::string> model_root_url_{"model_base_url", "https://ion-kit.s3.us-west-2.amazonaws.com/models/tlt_peoplenet_detectnet_v2_resnet18/"};
    GeneratorParam<std::string> cache_root_{"cache_root", "/tmp/"};
...
public:
    ...
    GeneratorParam<std::string> model_root_url_{"model_base_url", "https://ion-kit.s3.us-west-2.amazonaws.com/models/classify_gender/"};
    GeneratorParam<std::string> cache_root_{"cache_root", "/tmp/"};
